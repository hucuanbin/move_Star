...
$(document).ready(function () {
    ...
    turnplate.restaraunts = ["一等奖", "4元话费", "三等奖", "2元话费2元话费", "五等奖五等奖", "1元话费1元话费", "四等奖", "3元话费", "二等奖", "5元话费"];
    //   turnplate.colors = ["#FFF4D6", "#FFFFFF", "#FFF4D6", "#FFFFFF", "#FFF4D6", "#FFFFFF", "#FFF4D6", "#FFFFFF", "#FFF4D6", "#FFFFFF"];
    turnplate.colors = ["rgba(252,143,143,0.5)", "rgba(228,27,70,0)", "rgba(252,143,143,0.5)", "rgba(228,27,70,0)", "rgba(252,143,143,0.5)", "rgba(228,27,70,0)", "rgba(252,143,143,0.5)", "rgba(228,27,70,0)", "rgba(252,143,143,0.5)", "rgba(228,27,70,0)", ];
